  ...
  return (
    <View className="flex-1 bg-[#F8FAFC]">
      <View className="pt-14 pb-4 px-6 border-b border-[#F0F9FF] flex-row items-center bg-white">
        ...
        <Text className="text-xl font-bold text-[#0C4A6E]">Destinations</Text>
      </View>
      <View className="flex-1 items-center justify-center p-6">
        <Text className="text-[#486581] text-center font-medium">Destination management coming soon.</Text>
      </View>
    </View>
  );
}
